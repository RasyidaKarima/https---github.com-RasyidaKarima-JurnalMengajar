...
<div class="col-md-12 mt-2">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color: gray;"><a href="{{ route('jurnal.kepsek') }}">Jurnal</a></li>
...
<div class="col-md-12">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <br>
      <a href="{{route('jurnal.kepsek')}}" class="btn btn-sm btn-warning">Kembali</a>
    </div>
  </div>
</div>
@endsection
...
<script type="text/javascript">
  $(function() {
    var table = $('#data_users_side').DataTable({
                ...
                ajax: '{!! route('jurnal-riwayat.kepsek') !!}', // memanggil route yang menampilkan data json
