...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h4 class="m-0 font-weight-bold"> Tambah Absensi</h4>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ url('/absen-kepsek') }}/{{ auth()->user()->id }}" enctype="multipart/form-data">
                @csrf
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="{{ url('/absen-kepsek') }}" class="btn btn-success">Kembali</a>
        </div>
        </div>
    </div>
</div>
