...
<div class="col-md-12">
  <div class="card">
    <div class="card-header">
      ...
      <br>
      <a href="{{route('rppCreate.guru')}}" class="btn btn-sm btn-success" id="tambahRpp"><i class="fa fa-plus"></i> Tambah Data</a>
      <br>
    </div>
    <div class="card-body">
...
<script type="text/javascript">
  $(function() {
    var table = $('#data_users_side').DataTable({
                ...
                ajax: '{!! route('rpp.guru') !!}', // memanggil route yang menampilkan data json
