<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="<?php if($active == 'tanda_tangan'){ echo 'active'; } ?>"> <a href="/tanda-tangan"><i class="fa fa-check"></i> <span>Tanda Tangan</span></a></li>
    <li class="<?php if($active == 'rpp'){ echo 'active'; } ?>"> <a href="/rpp"><i class="fa fa-book"></i> <span>Rencana Pembelajaran</span></a></li>
