<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="<?php if($active == 'jabatan'){ echo 'active'; } ?>"> <a href="/jabatan"><i class="fa fa-user"></i> <span>Jabatan</span></a></li>
    ...
    <li> <a href="/galeri"><i class="fa fa-cog"></i> <span>Galeri</span></a></li>
