...
Auth::routes();
    ...
    Route::get('/modal/{id}', [App\Http\Controllers\jurnalController::class, 'show'])->name('show.index');
    ...
    Route::get('/cetak-pertanggal/{tglawal}/{tglakhir}', 'jurnalController@cetakPertanggal')->name('cetak-pertanggal');
